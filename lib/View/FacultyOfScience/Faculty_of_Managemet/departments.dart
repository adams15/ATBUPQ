...
class FacultyOfManagementScenceDpt extends StatefulWidget {
  const FacultyOfManagementScenceDpt({Key? key}) : super(key: key);

  @override
  _FacultyOfManagementScenceDptState createState() =>
      _FacultyOfManagementScenceDptState();
}

class _FacultyOfManagementScenceDptState
    extends State<FacultyOfManagementScenceDpt> {
