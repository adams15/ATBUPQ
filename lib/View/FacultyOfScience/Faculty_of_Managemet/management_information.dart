...
class ManagementInformationTechnology extends StatefulWidget {
  ManagementInformationTechnology({
    super.key,
  });

  @override
  State<ManagementInformationTechnology> createState() =>
      _ManagementInformationTechnologyState();
}

class _ManagementInformationTechnologyState
    extends State<ManagementInformationTechnology> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of management information technology '
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where('FacultyName', isEqualTo: 'Management')
                  .snapshots(),
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Management Information ')
                      .snapshots(),
                  builder: (BuildContext context,
