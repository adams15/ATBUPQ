...
class AccountingAndFinance extends StatefulWidget {
  AccountingAndFinance({
    super.key,
  });

  @override
  State<AccountingAndFinance> createState() => _AccountingAndFinanceState();
}

class _AccountingAndFinanceState extends State<AccountingAndFinance> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of accounting and finance '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Accounting')
                      .snapshots(),
                  builder: (BuildContext context,
