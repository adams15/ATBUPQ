...
class MechanicalEngineering extends StatefulWidget {
  MechanicalEngineering({
    super.key,
  });

  @override
  State<MechanicalEngineering> createState() => _MechanicalEngineeringState();
}

class _MechanicalEngineeringState extends State<MechanicalEngineering> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of mechanical engr. '
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Mechanical Engineering')
                      .snapshots(),
                  builder: (BuildContext context,
