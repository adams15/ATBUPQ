...
class ChemicalEngineering extends StatefulWidget {
  ChemicalEngineering({
    super.key,
  });

  @override
  State<ChemicalEngineering> createState() => _ChemicalEngineeringState();
}

class _ChemicalEngineeringState extends State<ChemicalEngineering> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of chemical engr. '
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Chemical Engineering')
                      .snapshots(),
                  builder: (BuildContext context,
