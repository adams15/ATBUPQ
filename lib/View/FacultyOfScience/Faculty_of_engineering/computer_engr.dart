...
class ComputerEngineering extends StatefulWidget {
  ComputerEngineering({
    super.key,
  });

  @override
  State<ComputerEngineering> createState() => _ComputerEngineeringState();
}

class _ComputerEngineeringState extends State<ComputerEngineering> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of computer engr. '
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Computer Engineering')
                      .snapshots(),
                  builder: (BuildContext context,
