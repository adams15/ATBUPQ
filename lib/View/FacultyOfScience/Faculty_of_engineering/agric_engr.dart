...
class AgricEngineering extends StatefulWidget {
  AgricEngineering({
    super.key,
  });

  @override
  State<AgricEngineering> createState() => _AgricEngineeringState();
}

class _AgricEngineeringState extends State<AgricEngineering> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of Agric engineering '
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Agricultural Engineering')
                      .snapshots(),
                  builder: (BuildContext context,
