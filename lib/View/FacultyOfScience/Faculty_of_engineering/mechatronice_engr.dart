...
class MechatronicsEngineering extends StatefulWidget {
  MechatronicsEngineering({
    super.key,
  });

  @override
  State<MechatronicsEngineering> createState() =>
      _MechatronicsEngineeringState();
}

class _MechatronicsEngineeringState extends State<MechatronicsEngineering> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of mechatronics engr. '
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Mechatronic Engineering')
                      .snapshots(),
                  builder: (BuildContext context,
