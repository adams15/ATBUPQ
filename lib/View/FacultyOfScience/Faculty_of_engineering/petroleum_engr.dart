...
class PetroleumEngineering extends StatefulWidget {
  PetroleumEngineering({
    super.key,
  });

  @override
  State<PetroleumEngineering> createState() => _PetroleumEngineeringState();
}

class _PetroleumEngineeringState extends State<PetroleumEngineering> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of petroleum engr. '
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Petroleum Engineering')
                      .snapshots(),
                  builder: (BuildContext context,
