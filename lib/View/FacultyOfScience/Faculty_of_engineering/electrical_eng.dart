...
class ElectricalEngineering extends StatefulWidget {
  ElectricalEngineering({
    super.key,
  });

  @override
  State<ElectricalEngineering> createState() => _ElectricalEngineeringState();
}

class _ElectricalEngineeringState extends State<ElectricalEngineering> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of electrical engr. '
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Electrical Engineering')
                      .snapshots(),
                  builder: (BuildContext context,
