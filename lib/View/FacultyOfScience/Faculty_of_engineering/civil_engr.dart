...
class CivilEngineering extends StatefulWidget {
  CivilEngineering({
    super.key,
  });

  @override
  State<CivilEngineering> createState() => _CivilEngineeringState();
}

class _CivilEngineeringState extends State<CivilEngineering> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of civil engr. '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Civil Engineering')
                      .snapshots(),
                  builder: (BuildContext context,
