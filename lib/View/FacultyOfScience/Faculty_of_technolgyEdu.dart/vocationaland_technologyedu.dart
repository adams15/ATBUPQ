...
class VocationalAndTechnologyEdu extends StatefulWidget {
  

  VocationalAndTechnologyEdu({
    super.key,
  });

  @override
  State<VocationalAndTechnologyEdu> createState() =>
      _VocationalAndTechnologyEduState();
}

class _VocationalAndTechnologyEduState
    extends State<VocationalAndTechnologyEdu> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of vocational and technology education '
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where('FacultyName', isEqualTo: 'Technology Education')
                  .snapshots(),
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Vocational Studies')
                      .snapshots(),
                  builder: (BuildContext context,
