...
class FoundationCourse extends StatefulWidget {
  FoundationCourse({
    super.key,
  });

  @override
  State<FoundationCourse> createState() => _FoundationCourseState();
}

class _FoundationCourseState extends State<FoundationCourse> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of foundation course '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Foundation Course')
                      .snapshots(),
                  builder: (BuildContext context,
