...
class LibraryAndInformation extends StatefulWidget {
  LibraryAndInformation({
    super.key,
  });

  @override
  State<LibraryAndInformation> createState() => _LibraryAndInformationState();
}

class _LibraryAndInformationState extends State<LibraryAndInformation> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of library and information science '
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Library and Information')
                      .snapshots(),
                  builder: (BuildContext context,
