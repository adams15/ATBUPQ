...
class ScienceEducation extends StatefulWidget {
  ScienceEducation({
    super.key,
  });

  @override
  State<ScienceEducation> createState() => _ScienceEducationState();
}

class _ScienceEducationState extends State<ScienceEducation> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of science education '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Science Education')
                      .snapshots(),
                  builder: (BuildContext context,
