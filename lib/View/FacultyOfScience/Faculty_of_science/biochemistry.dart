...
class BiochemistryDepartment extends StatefulWidget {
  ...
  @override
  State<BiochemistryDepartment> createState() => _BiochemistryDepartmentState();
}
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of biochemistry'
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Biochemistry')
                      .snapshots(),
                  builder: (BuildContext context,
