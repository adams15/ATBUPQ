...
class BiologyDepartment extends StatefulWidget {
  BiologyDepartment({
    super.key,
  });

  @override
  State<BiologyDepartment> createState() => _BiologyDepartmentState();
}

class _BiologyDepartmentState extends State<BiologyDepartment> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of biology '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Biological Science')
                      .snapshots(),
                  builder: (BuildContext context,
