...
class PhysicsDepartment extends StatefulWidget {
  ...
  @override
  State<PhysicsDepartment> createState() => _PhysicsDepartmentState();
}

class _PhysicsDepartmentState extends State<PhysicsDepartment> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of physics '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Physics')
                      .snapshots(),
                  builder: (BuildContext context,
