...
class MicrobiologyDepartment extends StatefulWidget {
  MicrobiologyDepartment({
    super.key,
  });

  @override
  State<MicrobiologyDepartment> createState() => _MicrobiologyDepartmentState();
}

class _MicrobiologyDepartmentState extends State<MicrobiologyDepartment> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of microbiology '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Microbiology')
                      .snapshots(),
                  builder: (BuildContext context,
