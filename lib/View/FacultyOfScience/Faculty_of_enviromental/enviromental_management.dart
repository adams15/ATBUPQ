...
class EnviromentalManagement extends StatefulWidget {
  EnviromentalManagement({
    super.key,
  });

  @override
  State<EnviromentalManagement> createState() => _EnviromentalManagementState();
}

class _EnviromentalManagementState extends State<EnviromentalManagement> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of Enviromental Management '
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Enviromental Management')
                      .snapshots(),
                  builder: (BuildContext context,
