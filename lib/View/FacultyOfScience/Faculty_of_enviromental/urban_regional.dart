...
class UrbanAndRegionalPlaning extends StatefulWidget {
  UrbanAndRegionalPlaning({
    super.key,
  });

  @override
  State<UrbanAndRegionalPlaning> createState() =>
      _UrbanAndRegionalPlaningState();
}

class _UrbanAndRegionalPlaningState extends State<UrbanAndRegionalPlaning> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of Urban and Regional Planing '
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where('FacultyName', isEqualTo: 'Enviromental')
                  .snapshots(),
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName',
                          isEqualTo: 'Urban and Regional Planing')
                      .snapshots(),
                  builder: (BuildContext context,
