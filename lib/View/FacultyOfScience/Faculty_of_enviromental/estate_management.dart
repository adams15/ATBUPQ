...
class EstateManagement extends StatefulWidget {
  EstateManagement({
    super.key,
  });

  @override
  State<EstateManagement> createState() => _EstateManagementState();
}

class _EstateManagementState extends State<EstateManagement> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of Estate Management '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Estate Management')
                      .snapshots(),
                  builder: (BuildContext context,
