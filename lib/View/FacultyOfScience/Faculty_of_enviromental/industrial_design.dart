...
class IndustrialDesign extends StatefulWidget {
  const IndustrialDesign({
    super.key,
  });

  @override
  State<IndustrialDesign> createState() => _IndustrialDesignState();
}

class _IndustrialDesignState extends State<IndustrialDesign> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of Industrial Design'
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Industrial Design')
                      .snapshots(),
                  builder: (BuildContext context,
