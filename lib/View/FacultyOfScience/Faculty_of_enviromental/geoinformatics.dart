...
class GeoInformatics extends StatefulWidget {
  GeoInformatics({
    super.key,
  });

  @override
  State<GeoInformatics> createState() => _GeoInformaticsState();
}

class _GeoInformaticsState extends State<GeoInformatics> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of GeoInformatics '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'GeoInformatics')
                      .snapshots(),
                  builder: (BuildContext context,
