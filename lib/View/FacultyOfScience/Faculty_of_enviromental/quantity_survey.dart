...
class QuantitySurvey extends StatefulWidget {
  QuantitySurvey({
    super.key,
  });

  @override
  State<QuantitySurvey> createState() => _QuantitySurveyState();
}

class _QuantitySurveyState extends State<QuantitySurvey> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of Quantity Survey '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Quantity Survey')
                      .snapshots(),
                  builder: (BuildContext context,
