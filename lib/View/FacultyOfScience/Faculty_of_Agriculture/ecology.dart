...
class Ecology extends StatefulWidget {
  Ecology({
    super.key,
  });

  @override
  State<Ecology> createState() => _EcologyState();
}

class _EcologyState extends State<Ecology> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of ecology '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Ecology')
                      .snapshots(),
                  builder: (BuildContext context,
