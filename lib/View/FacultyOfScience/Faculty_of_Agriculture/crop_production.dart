...
class CropProduction extends StatefulWidget {
  CropProduction({
    super.key,
  });

  @override
  State<CropProduction> createState() => _CropProductionState();
}

class _CropProductionState extends State<CropProduction> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of crop production '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Crop Production')
                      .snapshots(),
                  builder: (BuildContext context,
