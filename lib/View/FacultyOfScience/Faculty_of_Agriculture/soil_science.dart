...
class SoilScience extends StatefulWidget {
  SoilScience({
    super.key,
  });

  @override
  State<SoilScience> createState() => _SoilScienceState();
}

class _SoilScienceState extends State<SoilScience> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of soil science '
              ...
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Soil Science')
                      .snapshots(),
                  builder: (BuildContext context,
