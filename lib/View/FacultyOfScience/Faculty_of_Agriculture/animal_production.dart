...
class AnimalProduction extends StatefulWidget {
  AnimalProduction({
    super.key,
  });

  @override
  State<AnimalProduction> createState() => _AnimalProductionState();
}

class _AnimalProductionState extends State<AnimalProduction> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Gabata welcome to department of Animal Production '
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where('FacultyName', isEqualTo: 'Agriculture')
                  .snapshots(),
              builder: (BuildContext context,
                ...
                return StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where('DepartmentName', isEqualTo: 'Animal Production')
                      .snapshots(),
                  builder: (BuildContext context,
